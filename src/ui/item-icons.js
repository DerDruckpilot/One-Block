...
export const ITEM_ICON_PATHS = {
  ...
  clayBrick: `${ICON_BASE_PATH}/clay_brick.png`,
  unfiredBowl: `${ICON_BASE_PATH}/unfired_bowl.png`,
  bowl: `${ICON_BASE_PATH}/bowl.png`,
  unfiredJug: `${ICON_BASE_PATH}/unfired_jug.png`,
  jug: `${ICON_BASE_PATH}/jug.png`,
  rawWood: `${ICON_BASE_PATH}/raw_wood_log.png`,
  fiber: `${ICON_BASE_PATH}/plant_fiber_rope.png`,
  grassSeed: `${ICON_BASE_PATH}/grass_seeds.png`,
  treeSeed: `${ICON_BASE_PATH}/tree_seed.png`,
  springDrop: `${ICON_BASE_PATH}/spring_drop.png`,
  berry: `${ICON_BASE_PATH}/berry.png`,
  roastedBerries: `${ICON_BASE_PATH}/roasted_berries.png`,
  cookedSteak: `${ICON_BASE_PATH}/cooked_steak.png`,
  woodFloor: `${ICON_BASE_PATH}/wood_floor.png`,
  stoneFloor: `${ICON_BASE_PATH}/stone_floor.png`,
  workbench: `${ICON_BASE_PATH}/workbench.png`,
  window: `${ICON_BASE_PATH}/window.png`,
  ...
  axe: `${ICON_BASE_PATH}/axe.png`,
  scythe: `${ICON_BASE_PATH}/scythe.png`,
  lasso: `${ICON_BASE_PATH}/lasso.png`,
  arrow: `${ICON_BASE_PATH}/wooden_arrows.png`,
  stoneBall: `${ICON_BASE_PATH}/small_rock.png`,
  torch: `${ICON_BASE_PATH}/torch.png`,
  campfire: `${ICON_BASE_PATH}/campfire.png`,
  furnace: `${ICON_BASE_PATH}/furnace.png`,
  woodWall: `${ICON_BASE_PATH}/wood_wall.png`,
  door: `${ICON_BASE_PATH}/door.png`,
  fence: `${ICON_BASE_PATH}/fence.png`,
  gate: `${ICON_BASE_PATH}/gate.png`,
  bed: `${ICON_BASE_PATH}/bed.png`,
  chickenNest: `${ICON_BASE_PATH}/chicken_nest.png`,
  feedTrough: `${ICON_BASE_PATH}/feed_trough.png`,
  waterTrough: `${ICON_BASE_PATH}/water_trough.png`,
  table: `${ICON_BASE_PATH}/table.png`,
  chair: `${ICON_BASE_PATH}/chair.png`,
  ...
  rug: `${ICON_BASE_PATH}/rug.png`,
  plantPot: `${ICON_BASE_PATH}/plant_pot.png`,
  shelf: `${ICON_BASE_PATH}/shelf.png`,
  floorLantern: `${ICON_BASE_PATH}/floor_lantern.png`,
