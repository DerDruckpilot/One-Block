...
export const RESOURCE_DESCRIPTIONS = {
  earth: 'Platzierbarer Bodenblock. Erweitert die Insel.',
  stone: 'Robuster Rohstoff und platzierbarer Naturstein.',
  clay: 'Weicher Baustoff. Grundlage fuer Keramik und Ofenrezepte.',
  clayBrick: 'Gebrannter Baustoff fuer spaetere Bauprojekte.',
  unfiredBowl: 'Rohform aus Lehm. Muss im Ofen gebrannt werden.',
  bowl: 'Gebrannte Tonschale fuer einfache Verarbeitung.',
  unfiredJug: 'Rohform aus Lehm. Muss im Ofen gebrannt werden.',
  jug: 'Gebrannter Tonkrug fuer spaetere Nutzung.',
  woodFloor: 'Begehbarer Holzboden fuer Wohnbereiche.',
  stoneFloor: 'Begehbarer Plattenboden aus bearbeitetem Stein.',
  rawWood: 'Basisrohstoff fuer Werkzeuge, Bau und Moebel.',
  fiber: 'Pflanzenfaser fuer Seile, einfache Ausruestung und Deko.',
  grassSeed: 'Samen fuer Grasflaechen und natuerliche Inselteile.',
  treeSeed: 'Samen fuer Baumwachstum und spaetere Holzquellen.',
  springDrop: 'Magischer Tropfen fuer Wasser und feuchte Erde.',
  berry: 'Einfache Nahrung. Heilt 1 HP.',
  rawMeat: 'Rohes Fleisch. Kann gekocht werden.',
  roastedBerries: 'Warme Beerenmahlzeit. Heilt mehr als rohe Beeren.',
  cookedSteak: 'Gekochtes Fleisch. Stellt mehrere Herzen wieder her.',
  egg: 'Tierprodukt. Kann gegessen oder gebraten werden.',
  friedEgg: 'Gekochtes Ei. Heilt mehr als ein rohes Ei.',
  wool: 'Weiche Tierfaser fuer Kleidung und Wohnobjekte.',
  workbench: 'Ermoeglicht fortgeschrittenes Crafting.',
  woodenPickaxe: 'Werkzeug fuer bessere Rohstoffe am Kristall.',
  woodenSpear: 'Nahkampfwaffe fuer Tiere und Gegner.',
  slingshot: 'Fernkampfwaffe. Verbraucht Steinkugeln.',
  bow: 'Fernkampfwaffe. Verbraucht Pfeile.',
  axe: 'Werkzeug fuer Holz und Baeume.',
  scythe: 'Werkzeug fuer Gras, Fasern und Pflanzen.',
  arrow: 'Munition fuer den Bogen.',
  stoneBall: 'Munition fuer die Schleuder.',
  ammoPouch: 'Zubehoer. Erhoeht die Steinkugel-Kapazitaet.',
  quiver: 'Zubehoer. Erhoeht die Pfeil-Kapazitaet.',
  linenTunic: 'Kleidung. Gibt leichte Verteidigung.',
  travelBoots: 'Schuhe. Erhoehen die Bewegung leicht.',
  torch: 'Platzierbare Lichtquelle.',
  campfire: 'Platzierbares Feuer und Kochstelle.',
  furnace: 'Brennt Lehm und Keramik.',
  woodWall: 'Blockierende Holzwand fuer einfache Gebaeude.',
  window: 'Blockierendes Wandstueck mit Fenster. Verbindet mit Waenden und Tueren.',
  door: 'Oeffnbares Wandstueck fuer Durchgaenge.',
  fence: 'Zaunstueck fuer Gehege.',
  gate: 'Oeffnbares Zaunstueck fuer Gehege.',
  bed: 'Setzt Respawnpunkt und erlaubt Schlafen.',
  chickenNest: 'Tierhaltungsobjekt fuer Eierproduktion.',
  feedTrough: 'Futterstelle fuer Nutztiere.',
  waterTrough: 'Wasserstelle fuer Nutztiere.',
  table: 'Blockierendes Wohnobjekt.',
  chair: 'Begehbares kleines Moebelstueck.',
  rug: 'Begehbare Matte fuer Wohnbereiche.',
  plantPot: 'Kleiner Pflanzenkuebel. Blockiert das Feld.',
  shelf: 'Regal fuer Deko. Blockiert das Feld.',
  floorLantern: 'Begehbare kleine Laterne fuer warme Lichtpunkte.',
  lasso: 'Handwerkzeug, um friedliche Tiere zu fuehren.'
};
